...
But there still exist something wrong,though I didnt found them.
...
Then,please download the gsi(PE Arrow and so on).img, FBE_Disabler.zip and magisk17.1.zip(if boot failed please flash it,download link can be found below).

And
    reboot to recovery and wipe data
    reboot to recovery again
    mount all partions
    flash FBE_Disabler.zip
    finally,just flash the Gsi img
