...
Since the original device list is pretty long, all supported devices list are now categorized by brand. If you can't see your device's brand here, it could be placed at **Miscellaneous** category.
